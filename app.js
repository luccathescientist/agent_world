const TILE_SIZE = 32;
const WORLD_TOP_PADDING = 48;
const DEFAULT_WORLD_COLS = 30;
const DEFAULT_WORLD_ROWS = 18;
const DEFAULT_FLOOR_ATLAS_PATH = "/agent-world-static/assets/tiles/office_tileset/Office%20Tileset/Office%20VX%20Ace/A2%20Office%20Floors.png";
const DEFAULT_OFFICE_ATLAS_PATH = "/agent-world-static/assets/tiles/office_tileset/Office%20Tileset/Office%20Tileset%20All%2032x32.png";
const DEFAULT_WALL_ATLAS_PATH = "/agent-world-static/assets/tiles/office_tileset/Office%20Tileset/Office%20VX%20Ace/A4%20Office%20Walls.png";
const EMPTY_OBJECT = ".";
const OBJECT_TOKEN_EMPTY = ".";
const OBJECT_TOKEN_WALL = "wall";
const OBJECT_TOKEN_DOOR = "door";
const PASSABLE_DOOR_TILES = new Set(["9:15", "9:16"]);
const SEAT_FURNITURE_TILES = new Set(["1:17", "5:17", "1:19"]);
const ROOM_LANDMARK_TOKENS = [
...
const DEFAULT_CHAT_BUBBLE_FRAME = {
...
const DEFAULT_CHAT_TEXT_COLORS = {
  assistant: "#fff4d7",
  tool: "#d7e7ff",
  user: "#d8f3e8",
};
const AGENT_INACTIVE_HIDE_MS = 20 * 60 * 1000;
const AGENT_BUBBLE_PALETTES = [
...
const CHAT_BUBBLE_SLOT_LAYOUT = [
  ["tl", "tm", "tm", "tr"],
  ["ml", "mm", "mm", "mr"],
  ["ml", "mm", "mm", "mr"],
  ["bl", "bm", "bm", "br"],
];
const CHAT_BUBBLE_PREVIEW_SAMPLES = [
  {
    key: "short",
    role: "assistant",
    label: "Agent",
...
const CANONICAL_ANCHOR_ALIASES = {
  library: "library",
  books: "library",
  bookshelf: "library",
  terminal: "terminal",
...
const PATH_RE = /\/home\/[^/\s)"'`]+\/[^\s)"'`]+/g;
const DEFAULT_SELECTED_AGENT_ID = "lucca-main";
...
function getStoredMap(key, fallback) {
  try {
